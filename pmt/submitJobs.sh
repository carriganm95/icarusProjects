...
sourceDir="/pnfs/icarus/scratch/users/micarrig/pmtRecal/"
exe="runJob.sh"
export fclFile=""
export tarFile="pmtRecal.tar.gz"
export fileList=""
export outputDir="/pnfs/icarus/scratch/users/micarrig/pmtRecal/"
export nEvents=-1
export anaFile="getPMTRecal.py"
nJobs=260 #$(wc -l < ${sourceDir}/${fileList})
recopy=false
